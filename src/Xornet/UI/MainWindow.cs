...
public class MainWindow : Window
{
    ...
    public MainWindow(Scanner scanner, Killer killer) : base("Xornet - Network Commander")
    {
        _scanner = scanner;
        _killer = killer;
        ...
        _statusBar = new StatusBar(new StatusItem[]
        {
            ...
            new StatusItem(Key.F3, "~F3~ Kill", OnKillClicked),
            new StatusItem(Key.F4, "~F4~ Restore", OnRestoreClicked),
            new StatusItem(Key.F5, "~F5~ Restore All", OnRestoreAllClicked),
